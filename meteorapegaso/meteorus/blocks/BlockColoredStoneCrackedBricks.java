...
public class BlockColoredStoneCrackedBricks extends Block {
	...
	public BlockColoredStoneCrackedBricks(int par1, Material par2Material) {
	...
	public void registerIcons(IconRegister par1IconRegister)
	{
	       ...
	       {
	        icons[i] = par1IconRegister.registerIcon(Reference.MOD_IDFOLDER + ":" + this.colors[(i)] + "stonecrackedbrick");
	       }
	}
