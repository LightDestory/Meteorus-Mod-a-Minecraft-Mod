package meteorapegaso.meteorus.crafting;
...
public class ProjectCraftingManager {

	private static final ProjectCraftingManager instance = new ProjectCraftingManager();
	private List recipes = new ArrayList();
	
	public static final ProjectCraftingManager getInstance() {
	return instance;
	}
	public ProjectCraftingManager() {
	addRecipe(new ItemStack(MeteorusItemHandler.ProjectCarvedStone), new Object[]
	{"PAP","APA","PAP", Character.valueOf('P'), Item.paper, Character.valueOf('A'), new ItemStack(Item.dyePowder, 1, 0) });
